...
The files sprites.py and visualizer.py were provided by or modified from starter code generously provided by the brilliant David Liu, Professor at UofT.
